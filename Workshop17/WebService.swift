...
class WebService {
    ...
    func executeRequest (urlRequest:Request, LoginViewController:UIViewController? = nil, requestCompletionFunction:(Int,JSON) -> ())  {
        ...
        urlRequest.responseJSON { returnedData -> Void in  //execute the request and give us JSON response data
            ...
            if (success)    {
                ...
                if (self.handleCommonResponses(serverResponseCode, presentingViewController: LoginViewController))    {
